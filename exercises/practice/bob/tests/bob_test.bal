...
@test:Config {}
function testEndingWithNewline() {
    string response = hey("Okay if like my  spacebar  quite a bit?\n");
    string expected = "Sure.";
    test:assertEquals(response, expected);
}
...
@test:Config {}
function testShoutingEndingWithNewline() {
    string response = hey("HI!\n");
    string expected = "Whoa, chill out!";
    test:assertEquals(response, expected);
}

@test:Config {}
function testForcefullQuestionEndingWithNewline() {
    string response = hey("ARE YOU THERE?\n");
    string expected = "Calm down, I know what I'm doing!";
    test:assertEquals(response, expected);
}

@test:Config {}
function testForcefullQuestionWithNewline() {
    string response = hey("ARE YOU THERE\n?");
    string expected = "Calm down, I know what I'm doing!";
    test:assertEquals(response, expected);
}
...
@test:Config {}
function testYellingWithTwoLines() {
    string response = hey("\nHELLO!\nHOW ARE YOU!");
    string expected = "Whoa, chill out!";
    test:assertEquals(response, expected);
}
